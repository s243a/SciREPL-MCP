...
| [Playwright driver](packages/playwright-driver/) | Free-PWA, hosted-PWA, and local-browser workbook automation | The server launches or attaches to Chromium over CDP | Playwright and Chromium |
